...
# Implementation of IJTAB is similar with the sequential one.
# Since we need to compute next address before the next instruction, 
# we should stall 3 times for decode, execute, and memory stages. Because next PC is computed in memory stage.
# So in the fetch stage, PC is valM.
# In pipeline register stage bubbles and stalls are same as return's.
# In other stages, implementation is same as sequential processor.
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IJTAB };    #update
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
	     IIRMOVQ, IRMMOVQ, IMRMOVQ, IJTAB };         #Update

# Does fetched instruction require a constant word?
bool need_valC =
f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IJTAB };      #Update
...
word d_srcB = [
D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IJTAB  } : D_rB;               #Update
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJTAB } : E_valC;         #Update
...
E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IJTAB } : E_valB;             #Update
...
word mem_addr = [
	M_icode in { IRMMOVQ, IPUSHQ, ICALL, IMRMOVQ, IJTAB } : M_valE;    #Update
	M_icode in { IPOPQ, IRET } : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVQ, IPOPQ, IRET, IJTAB };        #Update
...
bool F_stall =
	...
	IJTAB in { D_icode, E_icode, M_icode } ||     #Update
